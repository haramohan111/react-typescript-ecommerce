...
import { CartList, coupon, decreaseQty, increaseQty, removeCart, userCart } from "../../actions/cartAction";
...
const UserCart = () => {
  ...
  useEffect(() => {
    if (params.id) {
      dispatch(userCart(params.id, toast, navigate, "cart"));
    }

  }, [dispatch, params.id])
  const cartList = useSelector((state:RootCartState) => state.cartreducer)
  ...
  const removeItemCart = (product_id: any) => {
                ...
                <table className="table table-borderless">
                  <thead className="text-muted">
                    <tr className="small text-uppercase">
                      ...
                      <th scope="col" className="text-end" style={{ width: '130px' }}></th>
                    </tr>
                  </thead>
                  <tbody>
                    {
              ...
              <div className="card-body">
                <dl className="row border-bottom">
                  <dt className="col-6">Total price:</dt>
                  {
                    ...
                    <dd className="col-6 text-end" >7777</dd>

                  }


                  <dt className="col-6 text-success">Discount:</dt>
                  <dd className="col-6 text-success text-end">-&#8360; {77777}</dd>
                  <dt className="col-6 text-success">
                    Coupon:{" "}
                    <span className="small text-muted">EXAMPLECODE</span>{" "}
                  </dt>
                  <dd className="col-6 text-success text-end">&#8360; {8888}</dd>
                </dl>
                <dl className="row">
