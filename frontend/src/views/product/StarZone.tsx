...
interface StarZoneViewProps {}

interface StarZoneViewState {}

class StarZoneView extends Component<StarZoneViewProps, StarZoneViewState> {
  constructor(props: StarZoneViewProps) {
    super(props);
    this.state = {};
  }
  render() {
