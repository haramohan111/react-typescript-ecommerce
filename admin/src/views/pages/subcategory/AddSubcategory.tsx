...
import { addSubcategory, manageSubcategory } from '../../../action/subcategoryAction';
import {
  CButton,
  CCard,
  CCardBody,
...
const AddSubcategory: React.FC = () => {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const data = { categoryid: inputs.categoryid, subcatename: inputs.subcategoryname, status: inputs.status };
    dispatch(addSubcategory(data, toast));
  };
      ...
      <CCol xs={12}>
        ...
        <CRow>
          <CCol md={3}>
            ...
            <CFormSelect id="validationCustom02" name="categoryid" required aria-label="select example" onChange={(e) => handleChange(e)}>
        ...
        <CRow>
          <CCol md={3}>
            <CFormLabel htmlFor="validationCustom01">SubCategory</CFormLabel>
            <CFormInput type="text" id="validationCustom01" name="subcategoryname" onChange={(e) => handleChange(e)} defaultValue="" placeholder='Enter Category' required />
        ...
        <CRow>
          <CCol md={3}>
            ...
            <CFormSelect id="validationCustom02" name="status" required aria-label="select example" onChange={(e) => handleChange(e)}>
