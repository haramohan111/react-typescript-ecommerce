...
import { addSubcategory, getSubcategoryById, manageSubcategory } from '../../../../action/subcategoryAction';
import { manageAllCategory } from '../../../../action/categoryAction';
import { addlistSubcategory } from '../../../../action/listsubcategoryAction';
import {
  CButton,
  CCard,
  CCardBody,
...
const AddListSubcategory: React.FC = () => {
  ...
  const handleCreate = (e:React.MouseEvent<HTMLButtonElement | HTMLAnchorElement>) => {
    ...
    try {
      ...
      dispatch(addlistSubcategory(data, toast));
    } catch (error) {
      console.log(error);
    }
  };
      ...
      <CCol xs={12}>
        ...
        <CRow>
          <CCol md={3}>
            ...
            <CFormSelect id="validationCustom02" name="categoryid" required aria-label="select example" onChange={(e) => {setCat(e.target.value);catgoryById(e.target.value)}}>
        ...
        <CRow>
          <CCol md={3}>
            ...
            <CFormSelect id="validationCustom02" name="categoryid" required aria-label="select example" onChange={(e) => setSubcat(e.target.value)}>
        ...
        <CRow>
          <CCol md={3}>
            ...
            <CFormInput type="text" id="validationCustom01"  name="categoryname"  onChange={(e) => setListsubcat(e.target.value)} placeholder='Enter List subcategory' required />
            <CFormFeedback invalid>Example invalid select</CFormFeedback>
          </CCol>
        </CRow>
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (form.checkValidity() === false) {
      ...
      // Only setValidated if the form is valid to avoid unreachable code
      setValidated(true);
    }
  };
    return (
