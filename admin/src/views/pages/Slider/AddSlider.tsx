...
import {
  ...
  CInputGroupText, CRow, CNavLink
} from '@coreui/react'
import {
  CTable, CTableBody, CTableCaption, CTableDataCell,
  CTableHead, CTableHeaderCell, CTableRow
} from '@coreui/react'
import { ThunkDispatch } from 'redux-thunk'
import { AnyAction } from 'redux'
import { addSlider,sliderPagination } from '../../../action/sliderAction'
...
const AddSlider: React.FC = () => {
  ...
  const categoryList = useSelector((state: RootState) => state.sliderReducer)
  ...
  const handlePageClick = (e: { selected: number }) => {
    ...
    dispatch(sliderPagination(currentPage.current, limit, search, setPageCount, setPageindex))
  }
  ...
  useEffect(() => {
    if (isSubmitted) {
      dispatch(sliderPagination(currentPageNum, limit, search, setPageCount, setPageindex))
    }
    dispatch(sliderPagination(currentPageNum, limit, search, setPageCount, setPageindex))
